...
public final class Alarm implements Parcelable, ClockContract.AlarmsColumns {
    ...
    private static final int INSTANCE_STATE_INDEX = 15;
    public static final int INSTANCE_ID_INDEX = 16;
    public static final int INSTANCE_YEAR_INDEX = 17;
    public static final int INSTANCE_MONTH_INDEX = 18;
    public static final int INSTANCE_DAY_INDEX = 19;
    public static final int INSTANCE_HOUR_INDEX = 20;
    public static final int INSTANCE_MINUTE_INDEX = 21;
    public static final int INSTANCE_LABEL_INDEX = 22;
    public static final int INSTANCE_DISMISS_ALARM_WHEN_RINGTONE_ENDS_INDEX = 23;
    public static final int INSTANCE_ALARM_SNOOZE_ACTIONS_INDEX = 24;
    ...
    public static boolean isDateSpecifiedTomorrow(int alarmYear, int alarmMonth, int alarmDayOfMonth) {
        Calendar today = Calendar.getInstance();
        Calendar tomorrow = (Calendar) today.clone();
        tomorrow.add(Calendar.DAY_OF_YEAR, 1);

        return (alarmYear == tomorrow.get(Calendar.YEAR)) &&
                (alarmMonth == tomorrow.get(Calendar.MONTH)) &&
