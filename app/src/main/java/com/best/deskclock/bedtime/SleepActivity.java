...
//TODO: create a playerservice as base and use it for playing songs, which works the regular way, so it doesn't disturb other service stuff.
// Creating a whole activity is too much trouble. Before that there should be a pickable sleeptone first.
