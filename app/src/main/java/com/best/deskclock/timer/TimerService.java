...
public final class TimerService extends Service {
     ...
     */
    public static final String ACTION_ADD_MINUTE_OR_HOUR_TIMER = ACTION_PREFIX + "ADD_MINUTE_OR_HOUR_TIMER";
    ...
    public static Intent createAddMinuteOrHourTimerIntent(Context context, int timerId) {
        return new Intent(context, TimerService.class)
                .setAction(ACTION_ADD_MINUTE_OR_HOUR_TIMER)
                .putExtra(EXTRA_TIMER_ID, timerId);
    }
        ...
        try {
            ...
            if (action != null) {
                switch (action) {
                    ...
                    case ACTION_ADD_MINUTE_OR_HOUR_TIMER -> {
                        Events.sendTimerEvent(R.string.action_add_minute_or_hour, label);
