        ...
        mPrefListener = (sharedPreferences, key) -> {
            ...
            switch (key) {
                case KEY_TAB_TITLE_VISIBILITY, KEY_TAB_INDICATOR, KEY_TAB_TO_DISPLAY, KEY_KEEP_SCREEN_ON, KEY_CLOCK_STYLE, KEY_CLOCK_DIAL,
                     ...
                     KEY_ENABLE_CITY_NOTE, KEY_AUTO_HOME_CLOCK, KEY_HOME_TIME_ZONE, KEY_WEEK_START, KEY_ALARM_FONT, KEY_TIMER_DURATION_FONT,
                     KEY_DISPLAY_COMPACT_TIMERS, KEY_SORT_TIMER, KEY_DISPLAY_TIMER_STATE_INDICATOR, KEY_RUNNING_TIMER_INDICATOR_COLOR,
