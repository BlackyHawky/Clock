...
public class MaterialYouAnalogAppWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateAppWidget(Context context, AppWidgetManager wm, int widgetId) {
        ...
        final boolean isSecondHandDisplayed =
                prefs.getBoolean(KEY_MATERIAL_YOU_ANALOG_WIDGET_WITH_SECOND_HAND, DEFAULT_MATERIAL_YOU_ANALOG_WIDGET_WITH_SECOND_HAND);
    ...
    private static RemoteViews relayoutWidget(Context context, AppWidgetManager wm, int widgetId, boolean isSecondHandDisplayed) {
        ...
        final RemoteViews widget = new RemoteViews(packageName, isSecondHandDisplayed
                ? R.layout.material_you_analog_appwidget_with_second_hand
                : R.layout.material_you_analog_appwidget_without_second_hand);
        ...
        if (WidgetUtils.isWidgetClickable(wm, widgetId)) {
            ...
            widget.setOnClickPendingIntent(isSecondHandDisplayed
                    ? R.id.analogAppwidgetMaterialYouWithSecondHand
                    : R.id.analogAppwidgetMaterialYouWithoutSecondHand, pi);
        }
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        SharedPreferences prefs = getDefaultSharedPreferences(context);
        prefs.edit().remove(KEY_MATERIAL_YOU_ANALOG_WIDGET_WITH_SECOND_HAND).apply();
    }
